...
class Config:
    ...
    bn_train = True
    init_model = osp.join(root_dir, 'data', 'imagenet_weights', 'resnet_v1_50')

    nr_skeleton = 17
    img_path = os.path.join('/home/zaikun/hdd/data/coco_2014')
    ...
    gt_path = osp.join('/home/zaikun/hdd/data/coco_2014/annotations', 'person_keypoints_val2014.json')

    det_path = osp.join('/home/zaikun/hdd/data/coco_2014/dets', 'person_detection_minival411_human553.json')
